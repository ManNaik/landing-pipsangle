...
export async function generateMetadata() {
  return buildPageMetadataFromConfig({
    ...
    description:
      "Latest financial market news, forex updates, and trading analysis. Stay informed on currency markets, central banks, and global macro news.",
    path: "/news",
    keywords: [
...
export default async function NewsPage() {
  const [items, siteConfig] = await Promise.all([getNewsItems(), getSiteConfig()]);
