...
export async function generateMetadata() {
  return buildPageMetadataFromConfig({
    title: "Blog | Forex Signals & Trading Guides",
    description:
      "Articles and guides on forex signals, automated trading, performance metrics, and risk management from PipAngel.",
    path: "/blog",
    keywords: [
      "forex trading blog",
      "forex signals guide",
      "automated forex trading articles",
...
export default async function BlogPage() {
  const [posts, siteConfig] = await Promise.all([getBlogPosts(), getSiteConfig()]);
